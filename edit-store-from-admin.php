		...
		<div class="row">
			<form  method="post">
				...
				<p>
					...
					<input type="text" name="loc" value="<?php echo $row[2]; ?>" >
				</p>
				<p>
					<label >City:</label><br>
					<input type="text" name="city" value="<?php echo $row[3]; ?>" >
				</p>
				<p>
					<label >Country:</label><br>
					<input type="text" name="country" value="<?php echo $row[4]; ?>">
				</p>
				</div>
...
<?php
		...
		$sql="UPDATE `store` SET `storeid`='$sid',`manager`='$smgrid',`location`='$loc', `country`='$country' WHERE storeid='$sid'";
