...
<div class="sidenav">	
	...
	include "odsms_config.php";
		...
		$sql = "SELECT medid, medname,medqty,medprice,medmf FROM medicine where storeid=$stid";
		...
		echo "<tr>";
			...
			echo "<td>" .$row["medmf"]."</td>";
			echo "<td align=center>";
						 
				echo "<a class='button1 edit-btn' href=UPDATE_MED.php?id=".$row['medid'].">Edit</a>";
			
				echo "<a class='button1 del-btn' href=del_med.php?id=".$row['medid'].">Delete</a>";
