...
<center>
	<div class="head">
	<h2> ( Profit / Loss ) REPORT COUNTRY WISE</h2>
	</div>
...
<div style="margin-left:30%; margin-top:3%;">	
	...
	$sql = "SELECT pid,storeid,medid,userid,pqty,pprice,pcost,pdate,pexp FROM purchase 
			WHERE pdate >= '$start' AND pdate <= '$end' AND storeid in (SELECT storeid from store where country='$country')";
	...
	<?php
	include "odsms_config.php";
	$sql = "SELECT saleid,storeid,userid,s_date,s_time,total_amt FROM sales
