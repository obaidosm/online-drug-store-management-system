...
<center>
	...
	<?php
		...
		$sql2 = "INSERT INTO employee VALUES ('','','$s_username','$s_password','$s_role','$s_name','$s_dob','$s_sex','$s_cnic','$s_doj','$s_num','$s_email','$s_address','$country')";
	...
	?>
			...
			<form  method="post">
				<div class="column">
					...
					<p>
						<label">City:</label><br>
			<input type="text" name="saddress" placeholder="" required>
					</p>
					<p>
			...
			<input type="submit" name="add" value="Add Country Manager">
			</form>
		<br>
