...
<center>
	<div class="head">
		<h2> All Store Managers of City </h2>
	</div>
</center>
...
<table align="right" id="table1" style="margin-right:100px;">
	...
	$qry="SELECT empcity FROM employee WHERE userid='$uid'";
	$row1= $conn->query($qry);
	$row2=$row1->fetch_row();
	$city=$row2[0];
		...
		$sql = "SELECT userid,storeid, username, password,role,empname, empdob, empgender, empcnic, empdoj, empmobile, empmail, empcity, empcountry
				FROM employee 
				WHERE empcity='$city' AND role='Store Manager'";
		...
		echo "<a class='button1 edit-btn' href=edit-storemanagers.php?id=".$row['userid'].">Edit</a>";
		echo "<a onclick='return confirm('Are you sure to delete?');' class='button1 del-btn' href=del-storemanager.php?id=".$row['userid'].">Delete</a>";
		echo "</td>";
	echo "</tr>";
	}
	echo "</table>";
