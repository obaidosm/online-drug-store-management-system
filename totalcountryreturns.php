...
<center>
	<div class="head">
	<h2> Total Country Returns Report</h2>
	</div>
</center>
	...
	$qry10="SELECT empcountry from employee where userid='$uid'";
...
<table align="right" id="table1" style="margin-right:10%;">
	...
	$sql = "SELECT rid,storeid,r_date,r_time,tr_amount FROM returns
			WHERE r_date >= '$start' AND r_date <= '$end' AND storeid in (SELECT storeid from store where country='$country')";
