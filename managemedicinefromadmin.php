...
<div class="sidenav">	
	...
	include "odsms_config.php";
		...
		$sql = "SELECT medid,storeid, medname,medqty,medprice,medmf FROM medicine ";
		...
		echo "<tr>";
			...
			echo "<td align=center>";
				...
				echo "<a class='button1 edit-btn' href=edit-MED.php?id=".$row['medid'].">Edit</a>";
			
				echo "<a class='button1 del-btn' href=del-meds.php?id=".$row['medid'].">Delete</a>";
