...
<center>
	...
	<?php
		...
		$s_stid = mysqli_real_escape_string($conn, $_REQUEST['stid']);
		

				
		$sql2 = "INSERT INTO employee VALUES ('','$s_stid','$s_username','$s_password','$s_role','$s_name','$s_dob','$s_sex','$s_cnic','$s_doj','$s_num','$s_email','$s_address','$country')";
	...
	?>
			...
			<form  method="post">
				<div class="column">
						...
						<input type=hidden name="role" Value="Store Manager">
						<p>
					...
					<p>
						...
						<input type="password" name="spassword"  placeholder="*********">
					</p>
					<p>
			...
			<input type="submit" name="add" value="Add Store Manager">
			</form>
		<br>
