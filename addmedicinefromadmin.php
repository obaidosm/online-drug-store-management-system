...
<div class="sidenav">	
	...
	<div class="one">
		<div class="row">
			<form action="addmedicinefromadmin.php" method="post">
				<div class="column">
					<p>
						<label for="storeid">Store ID:</label><br>
						<input type="number" name="storeid" min="1" >
					</p>
					<p>
		...
		if(isset($_POST['add']))
		{
		$storeid = mysqli_real_escape_string($conn, $_REQUEST['storeid']);
		...
		$qry10="SELECT * from employee where userid='$ename'";
		...
		$sql = "INSERT INTO medicine VALUES ($med_id,'$storeid', '$med_name',$med_quantity,$med_price,'$med_mf')";
		$sql2="INSERT INTO purchase VALUES ('','$med_id','$storeid','$user','$med_quantity','$pprice','','','$pmf','$pxp','$sid')";
