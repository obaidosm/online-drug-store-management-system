...
<table align="right" id="table1" style="margin-right:100px;">
	...
	include "odsms_config.php";
		...
		$sql = "SELECT userid,storeid, username, password,role,empname, empdob, empgender, empcnic, empdoj, empmobile, empmail, empcity, empcountry FROM employee  ";
		...
		echo "<a class='button1 edit-btn' href=update-employees.php?id=".$row['userid'].">Edit</a>";
		echo "<a onclick='return confirm('Are you sure to delete?');' class='button1 del-btn' href=del-employees.php?id=".$row['userid'].">Delete</a>";
		echo "</td>";
	echo "</tr>";
	}
	echo "</table>";
