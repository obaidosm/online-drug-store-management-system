...
<table align="right" id="table1" style="margin-right:100px;">
	...
	$country=$row2[0];
		...
		$sql = "SELECT userid,storeid, username, password,role,empname, empdob, empgender, empcnic, empdoj, empmobile, empmail, empcity, empcountry
				FROM employee 
				WHERE empcountry='$country' AND role='City Manager'";
		...
		echo "<a class='button1 edit-btn' href=edit-citymanager.php?id=".$row['userid'].">Edit</a>";
		echo "<a onclick='return confirm('Are you sure to delete?');' class='button1 del-btn' href=del-citymanager.php?id=".$row['userid'].">Delete</a>";
		echo "</td>";
	echo "</tr>";
	}
	echo "</table>";
