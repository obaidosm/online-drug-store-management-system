...
<center>
		...
		$result1 = $conn->query($qry1);
			...
			while($row1 = $result1->fetch_assoc()) {
				...
				echo "<tr>";
					...
					echo "<a name='delete' class='button1 del-btn' href=pordelbtn.php?mid=".$row1['medid']."&slid=".$sid.">Delete</a>";	
					echo "</td>";
				echo "</tr>";
				}
			echo "</table>";
	...
	?>
		...
		<form method=post>
		<a name='addnewsale' class='view-btn' href="addnewreturn.php?sid=".$sid.>Go Back to Sales Page</a> 
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type='submit' name='custadd'  value='Update Bill' ><br>
		</form>
