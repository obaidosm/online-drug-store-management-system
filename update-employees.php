...
?>		
		...
		<div class="row">
			<form  method="post">
				...
				<p>
					...
					<input type="text" name="role" value="<?php echo $row[4]; ?>">
				</p>
				<p>
	...
	<?php
		...
		$sql="UPDATE `employee` SET `username`='$username',`password`='$password',`role`='$role', `empname`='$ename',`storeid`='$sid',`empdob`='$dob',`empgender`='$sex',`empcnic`='$cnic',`empdoj`='$doj',`empmobile`='$mobile',`empmail`='$mail',`empcity`='$city' WHERE userid=$eid";
