...
<div style="margin-left:30%; margin-top:3%;">	
	...
	include "odsms_config.php";
		if(isset($_POST['submit'])) {
			...
			$res=mysqli_query($conn,"SELECT TPA('$start','$end') AS PAMT;") or die(mysqli_error($conn));
			...
			$res1=mysqli_query($conn,"SELECT TSA('$start','$end') AS SAMT;") or die(mysqli_error($conn));
